...
import { APP_BOOTSTRAP_LISTENER, ApplicationRef, InjectionToken, Provider, StateKey, TransferState, ɵformatRuntimeError as formatRuntimeError, inject, makeStateKey, ɵperformanceMarkFeature as performanceMarkFeature, ɵtruncateMiddle as truncateMiddle, ɵwhenStable as whenStable } from '@angular/core';
...
const CACHE_OPTIONS =
    new InjectionToken<CacheOptions>('');
